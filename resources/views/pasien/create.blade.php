                    ...
                    <div class="card-body">
                        <form action="{{ route('pasien.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="rumah_sakit" class="form-control select2">
                                    <option value="">Pilih Rumah Sakit</option>
                                        @foreach ($rs as $item)
                                            <option value="{{ $item->id }}">{{ $item->rumah_sakit }}</option>
                                        @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('pasien') is-invalid @enderror" name="pasien" value="{{ old('pasien') }}" placeholder="Pasien">
